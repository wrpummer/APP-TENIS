...
insert into public.match_sets (
  match_id, set_order, team_a_games, team_b_games, is_tiebreak, tiebreak_points_a, tiebreak_points_b
)
select
  inserted_match.id,
  set_rows.set_order,
  set_rows.team_a_games,
  set_rows.team_b_games,
  set_rows.is_tiebreak,
  set_rows.tiebreak_points_a,
  set_rows.tiebreak_points_b
from inserted_match
cross join (
  values
    (1, 7, 5, false, null, null),
    (2, 6, 4, false, null, null)
) as set_rows(set_order, team_a_games, team_b_games, is_tiebreak, tiebreak_points_a, tiebreak_points_b);
...
cross join (
  values
    (1, 6, 3, false, null, null),
    (2, 4, 6, false, null, null),
    (3, 1, 0, true, 10, 8)
) as set_rows(set_order, team_a_games, team_b_games, is_tiebreak, tiebreak_points_a, tiebreak_points_b);
...
cross join (
  values
    (1, 6, 1, false, null, null),
    (2, 6, 2, false, null, null)
) as set_rows(set_order, team_a_games, team_b_games, is_tiebreak, tiebreak_points_a, tiebreak_points_b);
...
cross join (
  values
    (1, 4, 6, false, null, null),
    (2, 7, 5, false, null, null),
    (3, 1, 0, true, 10, 7)
) as set_rows(set_order, team_a_games, team_b_games, is_tiebreak, tiebreak_points_a, tiebreak_points_b);
...
cross join (
  values
    (1, 6, 4, false, null, null),
    (2, 5, 7, false, null, null),
    (3, 7, 6, true, 7, 4)
) as set_rows(set_order, team_a_games, team_b_games, is_tiebreak, tiebreak_points_a, tiebreak_points_b);
